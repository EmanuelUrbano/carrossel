...
function mudar_href_estiver_em_foco(id_seta){
    ...
    const elemento_mostrando =  carrossel.scrollLeft
...
function indicador() {
   console.log((document.getElementById("carrossel").scrollLeft / (document.documentElement.scrollHeight - document.documentElement.clientHeight))*100)
}